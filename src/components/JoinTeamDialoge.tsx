...
const JoinTeamDialoge: React.FC<JoinTeamDialogeProps> = ({ dialogueIsOpen = false, setDialogueOpen }) => {
	...
	return (
		<>
			<CreateTeamDialogue
				showCreateTeamDialogue={showCreateTeamDialogue}
				setShowCreateTeamDialogue={setShowCreateTeamDialogue}
			/>
			<Dialogue
				dialogueIsOpen={dialogueIsOpen && !showCreateTeamDialogue}
			...
			>
				<div className="pb-2 flex">
					<form
						...
						className="flex flex-col items-center py-8 px-2 w-1/2"
