...
const AdminSettingsDialogue: React.FC<AdminSettingsDialogueProps> = ({
  teamName,
  teamID,
  totalMembers,
  ...rest
}) => {
  const [addMembersDialogueIsOpen, setAddMembersDialogueOpen] =
  ...
  return (
    <>
      ...
      <Dialogue
        {...rest}
        dialogueIsOpen={rest.dialogueIsOpen && !addMembersDialogueIsOpen}
          ...
          <div className="mt-4">
            <div className="flex items-center px-4">
              ...
              <AddIcon
                ...
                onClick={() => setAddMembersDialogueOpen(true)}
              />
            </div>
