...
export const getUserById = async (userID: UserID) => (await fetchUsingGET<GetUserByIdResponse>(APIRoutes.GET_USER_BY_ID, [userID])).data;
...
export const leaveUserFromTeam = async (teamID: TeamID) => await fetchUsingDelete<any>(APIRoutes.USER_LEAVE_TEAM, null, [teamID]);
